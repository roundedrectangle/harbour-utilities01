...
cattrs.global_converter.register_unstructure_hook(Repository, lambda model: {
    'hash': model.hashed_url,
    **_repo_unstructure_hook(model),
    'icon': caching.cacher.easy(model.icon, 'repoPropertyUpdate', 'icon', model.hashed_url),
    'banner': caching.cacher.easy(model.banner, 'repoPropertyUpdate', 'banner', model.hashed_url),
})
